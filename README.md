...
1. **Locally with Streamlit** – for a lightweight development setup.  
2. **In Docker** – for reproducible deployments without polluting your system environment.  
...
The application requires a minimal `.env` file:  
